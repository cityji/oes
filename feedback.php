            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-5">
                            <a href="https://cityji.github.io/portfolio/"
                                style="color:#A8D1FD; font-family:'typo' ; font-size:18px"
                                title="Find on Facebook">HexARRAYS</a>
                            <h4 style="color:#A8D1FD; font-family:'typo' ;font-size:16px" class="title1">+91 6263823386
                            </h4>
