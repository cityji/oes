...
<div class="row">
<div class="col-lg-6">
<span class="logo">QUIZLET: E-qUIZ</span></div>
  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
        ...
        <li <?php if(@$_GET['q']==2) echo'class="active"'; ?>><a href="account.php?q=2"><span class="glyphicon glyphicon-list-alt" aria-hidden="true"></span>&nbsp;Archive</a></li>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
		...
		<div class="col-md-4">
		 ...
		 <div class="col-md-5">
		<a href="http://yugeshverma.blogspot.in" style="color:#A8D1FD; font-family:'typo' ; font-size:18px" title="Find on Facebook">HexARRAYS</a>
		...
		<h4 style="font-family:'typo' ">APS UNIVERSITY</h4></div></div>
		</p>
      </div>
